...
- [x] 10-03-PLAN.md (10-03-api-routes) — /api/chat streamText route + /api/starter-questions cache-then-generate route (Wave 2)
- [x] 10-04-PLAN.md (10-04-ui-components) — 6 chat React components (ChatPanel, ChatInterface, ChatMessage, StarterQuestions, ChatLoadingSkeleton, GuardrailDeflection) + 2 render tests (Wave 3)
